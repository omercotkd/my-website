...
export const PlaneIcon = createSvgIcon(
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
export const DumbbellIcon = createSvgIcon(
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
export const ChefHatIcon = createSvgIcon(
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
export const GraduationCapIcon = createSvgIcon(
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
export const PercentageStarIcon = (
  { percentage }: { percentage?: number } = { percentage: 50 }
) => {
